...
export default function CheckoutForm(props) {
  const { checkoutProp, overrides, ...rest } = props;
  ...
  return (
    <Flex
      ...
      {...getOverrideProps(overrides, "CheckoutForm")}
      {...rest}
    >
      <Flex
        gap="0"
        ...
        >
          ...
          >
            ...
            <TextField
              width="unset"
              height="unset"
              label={authAttributes["phone_number"]}
            ...
            <TextField
              width="unset"
              height="unset"
              label={authAttributes["email"]}
              placeholder="abcd@student.nitw.ac.in"
              shrink="0"
              alignSelf="stretch"
              size="large"
              isDisabled={false}
              labelHidden={false}
              variation="default"
              {...getOverrideProps(overrides, "TextField37452794")}
            ></TextField>
            <TextField
              width="unset"
              height="unset"
